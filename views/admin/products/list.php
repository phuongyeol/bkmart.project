	...
	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header ">
				<span class="text-uppercase">Product Management </span>
				<span>
					<a title="Add new" class="btn fa fa-plus btn btn-success" data-toggle="modal" data-target="#product_add_modal"></a>
				</span>
			</h2>
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-center" width="20%">
						...
						<!-- delete -->
						<a href="?mod=product&act=del&id=<?php echo $product['id'] ?>" title="Delete" class="delete btn btn-sm" style="color: red"><i class="fa fa-trash"></i></a>
					</td>
				</tr>
